...
?>	
	...
	<section>
		...
		<div id="news" class="container">
			...
			<button id="btn-news-prev" type="button"> <i class="fa fa-chevron-left"></i></button>
			<button id="btn-news-next" type="button"> <i class="fa fa-chevron-right"></i></button>

			<div class="row thumbnails owl-carousel owl-theme">
				<div class="item"> 
					<div class="item-inner">
						<img src="img/noticia-thumb.jpg" alt="Noticia">
						<h3>Orlando City Acquires Golakeeper Joe Bendik from Toronto  FC</h3>
	...
	<div id="call-to-action">
		<div class="container">
			<div class="row text-center">
				<h2>American club number one in Brazil
